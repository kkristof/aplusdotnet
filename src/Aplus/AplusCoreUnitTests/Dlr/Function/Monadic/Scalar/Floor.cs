...
namespace AplusCoreUnitTests.Dlr.Function.Monadic.Scalar
{
    ...
    public class Floor : AbstractTest
    {
        ...
        public void FloorVectorUni()
        {
            ...
            AType result = this.engineUni.Execute<AType>("M.- 10 10.2 10.5 10.98 -9 -9.2 -9.5 -9.98  -0.1 -5.000000000000000000000002");
        ...
        [TestCategory("DLR"), TestCategory("Monadic"), TestCategory("Floor"), TestMethod]
        public void FloorVectorIntegerArgumentUni()
        {
            AType expected = AArray.Create(
                ATypes.AInteger,
                AInteger.Create(10),
            ...
            AType result = this.engineUni.Execute<AType>("M.- 10 10 10 11 -9 -9");
